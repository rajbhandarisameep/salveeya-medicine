...
- Your job: intelligebt routing.
- Read the directives, call execution tolls in the right order, handle errors, ask clarifying questions, update directives with what you learn
...
**Why it works:**
If you d oeverything yourself, errors compound. 
90% accuracy per step = ~59% success over 5 steps.
The solution is to push complexity into derterministic code so you focus only on decision-making.
...
Before writing a scripts;
- Check 'execution/' according to your directive
- Check new scripts only if none exist

### 2. Self-correct when something breaks
- Read the error message and stack trace
- Fix the scripts and test again
